...
|1|[Exam 2](https://github.com/AaronYang2333/CSCI_570/blob/master/exam2/Exam_2_Rubrics.pdf)|[Practice Material](https://github.com/FreddieMercy/CSCI_570/blob/FreddieMercy-patch-1/exams/exam2/Practice%20Exam%202.pdf) |`Runtime Complexity` `BFS` `DDFS` `Induction Proof` `Graph` `Divide-and-Conquer ` `Dynamic Programming` `Master Theorem`|100/100|
